...
public class Worksheet
{
    ...
    public class BackgroundService(IWebHostEnvironment hostEnv, Worksheet worksheet, ILogger<BackgroundService> logger) : IHostedService
    {
        public async Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            {
                tasks.Add(CreateWordbookAsync(@class, cancellationToken));
            }
        ...
        private async Task<(Class, Wordbook)> CreateWordbookAsync(Class @class, CancellationToken cancellationToken)
        {
